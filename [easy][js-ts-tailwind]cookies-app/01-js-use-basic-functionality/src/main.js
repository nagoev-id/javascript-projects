...
function initDOMElements() {
  APP_STATE.elements = {
    cookieConsent: document.querySelector(APP_CONFIG.selectors.cookieConsent),
    cookieAccept: document.querySelector(APP_CONFIG.selectors.cookieAccept),
    cookieDecline: document.querySelector(APP_CONFIG.selectors.cookieDecline),
  };
}
  ...
  if (!hasConsent) {
    [APP_STATE.elements.cookieAccept, APP_STATE.elements.cookieDecline].forEach(button =>
      button.addEventListener('click', ({ target }) => {
        ...
        if (target.matches(APP_CONFIG.selectors.cookieAccept)) {
